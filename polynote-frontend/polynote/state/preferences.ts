...
export type NotebookSorting = { descending: boolean };
...
export const NotebookSortingHandler = new LocalStorageHandler<NotebookSorting>("NotebookOrder", {descending: true});
