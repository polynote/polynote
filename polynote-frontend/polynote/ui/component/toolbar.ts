    ...
    constructor(connectionStatus: StateView<"disconnected" | "connected">) {
        ...
        const updateSelectorLanguages = (langs: Record<string, string>) => {
            ...
            if (langEntries.length > 0) {
                ...
                // Add markdown to the list of available languages
                // We can't add it to the interpreters directly or else it will be available in the code cell language dropdown as well
                this.langSelector.addOption("Markdown", "markdown");
