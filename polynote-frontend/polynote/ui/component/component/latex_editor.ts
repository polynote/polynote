import {div, para, span, TagElement, textbox} from "../../util/tags";
...
export class LaTeXEditor {
    ...
    constructor(private cell: TextCellComponent, readonly outputEl: HTMLElement, readonly parentEl: HTMLElement, readonly deleteOnCancel: boolean, readonly displayMode: boolean = false) {
    ...
    static forSelection(cell: TextCellComponent) {
        const selection = document.getSelection()!;
        ...
        return new LaTeXEditor(cell, el, notebookParent, deleteOnCancel, displayMode);
    }
}