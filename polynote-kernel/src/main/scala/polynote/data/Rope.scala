...
sealed abstract class Rope {
  ...
  /*
   * TODO: Should this blindly apply all the edits? What if subsequent edits depend on / are invalidated by previous
   *       edits? Need to investigate whether multiple edits (i.e. generated by monaco or jsdiff) take the previous
