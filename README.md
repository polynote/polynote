...
Polynote is an experimental polyglot notebook environment. Currently, it supports Scala, Python (with or without Spark),
SQL, and Vega.
...
- *Runtime insight* – Polynote keeps you informed of what's going on at runtime:
